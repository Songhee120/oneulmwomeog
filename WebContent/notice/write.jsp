           	...
           	<form action="${pageContext.request.contextPath}/notice/NoticeWriteOk.no" method="post" name="notice_form">
           		<table border="1" style="margin-bottom:0px;">
           			<tr height="30px">
           				...
           				<td>
           					<input name="notice_title" type="text" style="padding:0px">
           				</td>
           			</tr>
           			<tr height="30px">
           			...
           			<tr>
           				...
           				<td colspan="2" height="300px">
           					<textarea name="notice_content" style="height:300px;resize:none;"></textarea>
           				</td>
           			</tr>
           		</table>
				<div style="text-align:right;position:relative;top:10px">
					<button type="button" onclick="notice_submit()">등록</button>
