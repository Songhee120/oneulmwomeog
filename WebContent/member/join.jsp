         ...
         <article id="signup" class="panel">
            ...
            <form action = "${pageContext.request.contextPath}/member/MemberJoinOk.me" method="post" name="form">
               ...
               <div class="col-12">
                  ...
                  <input type="text" name="join_email" style="width:75%;display:inline-block"/>
                  <input type="button" onclick="mean()" class="mean_btn" name="email_mean_btn" value="중복확인">
               ...
               <div class="col-12">
                  <label for="name" id="jogin_label">이름</label>                             
               ...
               <div class="col-12" style="margin: 0 auto; display: block;">                  
                  ...
                  <div style="padding:0px;">
                  	<input type='text' name='tel' style="width:75%;margin-left:0px;display:inline-block;" placeholder="01012345678"/>
                  	<input type="button" onclick="mean()" class="mean_btn" name="phone_mean_btn" value="인증">
...
<script>
	...
	function join_check() {
		...
		if(form.join_email.value == ""){
			...
			var email_msg = null;
			if(!form.join_email.value.includes('@')){
				email_msg = "옳바른 형식이 아닙니다.";
				check = true;
			}else{
				email_msg = "";
			}
			$("#email_result").text(email_msg);
		}
		...
		if (form.tel.value == "") {
			...
			var tel_msg = null;
			//숫자가 아니거나 길이가 11자리수가 아니라면
			if(isNaN(form.tel.value) || form.tel.value.length != 11){
				tel_msg = "옳바른 입력이 아닙니다.";
				check = true;
				console.log('들어옴1');
			}else{
				console.log('들어옴2');
	...
	$("#email_mean_btn").click(function(){
		$.ajax({
			url:contextPath + "/member/MemberEmail.me",
			type:"get",
			data:{"email": $("input[name='join_email']").val()},
			dataType:"text",
			success:function(result){
