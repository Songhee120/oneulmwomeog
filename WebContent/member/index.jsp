...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<!-- Nav -->
		<nav id="nav" style="">
			<a href="#home" onclick="home_rollback()" class="icon solid fa-home"><span>Home</span></a>
			<a href="#post" class="icon solid fa-folder"><span>Post</span></a> <a
				href="#signup" onclick="signup_rollback()"
				class="icon solid fa-sign-in-alt"><span>SignUp</span></a> <a
				href="#login" class="icon solid fa-user"><span>Login</span></a>
		</nav>
		...
		<div id="main">
			...
			<article id="home" class="panel" style="padding-top: 2.5em;">
				<section id="my_home">
					...
					<div id="my_home_div2">
						...
						<button id="home_select_btn" onclick="dessertClicked()">카페
							갈래?</button>
					</div>
				</section>
				...
				<section id="food_area">
					...
					<div class="random_area">
						<p>
							그렇다면 오늘은,<span style="color: pink; font-size: 40px;"><u>햄버거</u></span>먹!
						</p>
					</div>
					<!-- 랜덤 뿌려주는 곳 끝! -->
					...
					<div class="selectNmapLeft">
						<div class="select_nonMember">
							<div class="select_area">
								<select name="choice" style="width: 115px;">
									<option value="" disabled selected>오늘은 몇명?</option>
									<option value="one">혼자</option>
									<option value="two">두명 이상</option>
									<option value="mul">단체</option>
								</select> <select name="choice" style="width: 114px;">
									<option value="" disabled selected>얼마있니?</option>
									<option value="manwonUp">만원 이상</option>
									<option value="manwonDown">만원 이하</option>
								</select> <select name="choice" style="width: 114px;">
			...
			<article id="post" class="panel" style="text-align: center;">
				...
				<div style="text-align: center;">
					...
					<a href="${pageContext.request.contextPath}/review/ReviewNewViewFirst.re"
						style="color: rgb(119, 119, 119);">NEW</a></span>
				</div>
				<!-- best 인증 -->
				<section id="best_area" style="display: block; text-align: center;">
					...
					<br>
					<div class="row"> 
						<div id="noReviewNotice">
							"당일 게시물이 아직 올라오지 않았습니다.
							첫번째 게시물을 올려주세요!"
						</div>
					</div>
					<br>
					<p style="float: right; margin: 20px;">
						<a href="${pageContext.request.contextPath}/review/ReviewWrite.re">[write]</a>
					</p>
				</section>
			</article>
			<!--회원가입 이용약관 -->
				...
				<form action="#" method="post">
					<div>
						<div class="row">
							...
							<div class="col-12">
								<textarea id="message1" name="message1" class="message" rows="6"
									readonly>
제1조 (목적)
...
본 약관은 2018년 4월 02일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.                  
								...
								<span id="span_box"> <input type="checkbox"
									class="agree_box" id="first_box" name="ckbox"> <label
									id="label_box">오늘뭐먹 이용약관 동의<span id="need_span">(필수)</span>
										<span style="display: none;" id="first_box_errmsg"></span></label>
								</span>
							</div>
							<div class="col-12">
								<textarea id="message2" name="message2" class="message" rows="6"
									readonly>
...
이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는 최소한의 개인정보, 즉, 필수 항목에 대한 수집 및 이용 동의를 거부하실 경우, 회원가입이 어려울 수 있습니다.               
								...
								<span id="span_box"> <input type="checkbox"
									class="agree_box" id="second_box" name="ckbox"> <label
									id="label_box">개인정보 이용약관 동의<span id="need_span">(필수)</span>
										<span style="display: none;" id="second_box_errmsg"></span>
								</label>
								</span>

							</div>
							<div class="col-12">
								<textarea id="message3" name="message3" class="message" rows="6"
									readonly>
제 1 조 (목적)
...
이메일 주소: navercc@naver.com                  
								...
								<span id="span_box"> <input type="checkbox"
									class="agree_box" name="ckbox"> <label id="label_box">위치정보
										이용약관 동의<span id="need_span">(선택)</span>
								</label>
								</span>
								<div style="text-align: center;">
									<span id="span_box"> <input type="checkbox"
										id="checkall" class="agree_box" name="ckbox"> <label
										id="label_box">전체 동의</label>
									</span>
								</div>
							</div>
							...
							<div class="col-12" style="text-align: center;">
								<button type="button" class="btn"
									style="width: 120px; height: 50px" onclick="confirm_check()">확인</button>
								<button type="submit" class="btn"
									style="width: 120px; height: 50px" onclick="cancel_check()">취소</button>
							</div>
						</div>
					</div>
				</form>
			...
			<article id="login" class="panel">
				<header style="text-align: center;">
					<a href="#home"
						style="text-decoration: none; font-size: 45px; color: #ffcccc; font-weight: 900;">오늘뭐먹</a>
				</header>
				<form name="login"
					action="${pageContext.request.contextPath}/member/MemberLoginOk.me"
					method="post">
					<div class="col-12">
						<label id="jogin_label">아이디 <input type="text"
							name="login_email" /></label> <span class="jogin_span"
							id="login_id_result"></span>
					</div>
					<div class="col-12">
						<label id="jogin_label" style="margin-bottom: 0;">비밀번호 <input
							type="password" name="login_password" /></label> <span
							class="jogin_span" id="login_pw_result"></span>
					</div>

					<div style="margin: 0 auto; width: 50%;">
						<a class="find_id_pw" href="findId.jsp">아이디 찾기 </a> <span>·</span>
						<a class="find_id_pw" href=findPw.jsp">비밀번호 찾기 </a>
					</div>
					<div class="col-12" style="margin: 0 auto; text-align: center;">
						<input type="button" id="login_btn" onclick="login_check()"
							value="로그인"
							style="border-radius: 10px; border: 1px solid #bdbdbd; color: black; font-size: 14px;">
					</div>
				</form>
			</article>
		</div>
