...
public class MemberVO {
	...
	public int getMem_review_cnt() {
		return mem_review_cnt;
	}

	public void setMem_review_cnt(int mem_review_cnt) {
		this.mem_review_cnt = mem_review_cnt;
	}
